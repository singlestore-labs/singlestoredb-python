...
GRAMMAR = Grammar(r'''
    ...
    in_region = ~"in"i ws ~"region"i ws (~"id" ws)? qs ws
    with_password = ~"with"i ws ~"password"i ws qs ws
    with_firewall_ranges = ~"with"i ws ~"firewall"i ws ~"ranges"i ws qs (comma qs)* ws
    expires_at = ~"expires"i ws ~"at"i ws qs ws
    in_group = ~"in"i ws ~"group"i ws (~"id" ws)? qs ws
    ...
    create_workspace_group = ~"create"i ws ~"workspace"i ws ~"group"i ws qs in_region ( with_password / expires_at / with_firewall_ranges )* ws
